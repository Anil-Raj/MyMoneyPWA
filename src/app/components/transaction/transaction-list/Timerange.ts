...
export class Timerange {
    ...
    getTimeRangeList(a, viewByFilter): any {
        ...
        while (day <= end) {
            switch (range) {
                case 'month': timerange.push(this.getTimeRange(day, range));
                    break;
                case 'week': timerange.push(this.getTimeRange(day, range));
                    break;

                case 'day': timerange.push(this.getTimeRange(day, range));
