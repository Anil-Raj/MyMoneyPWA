...
exports.Currency = {
    defaultBase: 'USD',
    options: function () {
        return Object.keys(CURRENCY).map(function (code) { return ({
            key: code,
            value: code,
     ...
     * @param {bool} format
     */
    toFloat: function (value, code, format) {
    ...
    convert: function (value, rate, from, to) {
